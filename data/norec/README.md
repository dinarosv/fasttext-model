# Install NoReC for this repo
Download norec-1.0.1.tar.gz from http://folk.uio.no/eivinabe/ and put the html.tar.gz in addition to metadata.json in this directory. Then run the norec_prep.py. This will create train- and testfiles: train.txt and test.txt. Afterwards you can run trainmodel.py (from root folder) with these files.
